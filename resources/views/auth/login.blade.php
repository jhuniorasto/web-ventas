...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="author" content="BinaryGuardian" />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="mt-5 border-0 rounded-lg shadow-lg card">
                                    <div class="card-header"><h3 class="my-4 text-center font-weight-light">Login</h3></div>
                                    <div class="card-body">
                                        <form>
                ...
                <footer class="py-4 mt-auto bg-light">
                    <div class="px-4 container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Paul Sanchez Benites</div>
                            <div>
